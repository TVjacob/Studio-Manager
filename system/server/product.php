...
function saveProduct(Product $newproduct)
{
    ...
    $sql = "INSERT INTO account (productname, rate, amount)
    VALUES ('$prodctname', '$rate', '$amount')";
...
function updateProduct(Product $updateProduct)
{
    ...
    $sql = "UPDATE product SET productname='" . $productname . "', rate='" . $rate . "', amount='" . $amount . "' WHERE acountCode='" . $updateProduct->getID() . "'";
    if (mysqli_query($conn, $sql)) {
